...
cap = cv2.VideoCapture('/home/kidus/Desktop/smart_traffic/src/dataset/video2.avi')
cascade_src = '/home/kidus/Desktop/smart_traffic/src/dataset/cars.xml'
car_cascade = cv2.CascadeClassifier(cascade_src)


pub = rospy.Publisher("/lane2_cars", stampedInt, queue_size= 10)
...
while not rospy.is_shutdown():
	...
	if not (type(frame) == type(None)):
		...
		try:
			...
			cv2.imshow("Live Feed Camera 2", frame)
			cv2.waitKey(20)
