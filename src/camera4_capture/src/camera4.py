...
cap = cv2.VideoCapture('/home/kidus/Desktop/smart_traffic/src/dataset/video4.avi')
cascade_src = '/home/kidus/Desktop/smart_traffic/src/dataset/cars.xml'
car_cascade = cv2.CascadeClassifier(cascade_src)


pub = rospy.Publisher("/lane4_cars", stampedInt, queue_size= 10)
...
while not rospy.is_shutdown():
	...
	if not (type(frame) == type(None)):
		...
		try:
			...
			cv2.imshow("Live Feed Camera 4", frame)
			cv2.waitKey(20)
